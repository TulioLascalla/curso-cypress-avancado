describe('Hacker Stories', () => {
  ...
  context.skip('Hitting the real API', () => {
    ...
    it('searches via the last searched term', () => {
      ...
      cy.wait('@getStories')
      cy.get('.item').should('have.length', 20)
      cy.get('.item').should('be.visible').and('contain', initialTerm)
  ...
  context('Mocking the API', () => {
    ...
    context('Search', () => {
      ...
      it('types and hits ENTER', () => {
        ...
        cy.get('.item').should('have.length', 2) // Existem 20 itens assim ?
...
it.skip('shows "Loading ..." state before showing the results', () => {
  cy.intercept(
      'GET',
      '**/search**',
      {
